...
@interface ViewController ()<HJPickerViewDelegate>
...
-(void)show{
    ...
    HJPickerView *pickerView = [[HJPickerView alloc]initWithDatas:province delegate:self valuesDic:city,country, nil];
...
-(void)selectedValues:(NSArray *)values{
    NSLog(@"%@",values);
